...
def get_pages(url, cur):
    ...
    success_log_file = open('../Logs/success.log', mode='a', encoding='UTF-8')
    error_log_file = open('../Logs/error.log', mode='a', encoding='UTF-8')
    ...
    for card_list in card_list_soup.select('#wikibody table td:nth-of-type(2) a[href*="w.atwiki.jp/hachinai_nanj/pages/"]'):
        ...
        try:
            ...
            with open('../Logs/card_info_log.json', encoding='utf-8', mode='w') as f:
